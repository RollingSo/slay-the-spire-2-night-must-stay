...
- 项目特例：复仇者的“古龙信仰、癫狂叁指、黄金律法、野兽爪痕”属于祷告体系，允许并要求使用展开卷轴作为统一系列载体；卷轴不得包含可读规则文字、卡框或尖塔卡牌结构。
...
女爵人物卡图还必须遵守 `design/duchess/女爵视觉形象强制规范.md`，以官方形象及本 Mod 已定稿的角色图固定发型、雕纹眼罩、服装和武器。除「隙间月影」明确允许太刀外，未特别指定的女爵卡图一律使用短直刃短剑；不得擅自改成长刀、刺剑或飞刀。出现纯黑布带式眼罩时须直接退稿。
