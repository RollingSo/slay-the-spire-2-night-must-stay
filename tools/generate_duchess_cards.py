    ...
    for effect in row[7]:
        ...
        if kind == 'Damage':
            ...
            templates = {
                ...
                'FullBlockRadiantBlade': [f'本回合完全格挡住攻击时，将{var}张[gold]辉剑[/gold]加入[gold]手牌[/gold]。', f'Whenever you fully block an attack this turn, add {var} [gold]Radiant Blades[/gold] to your [gold]hand[/gold].', f'このターン攻撃を完全に防いだとき、[gold]輝剣[/gold]を{var}枚[gold]手札[/gold]に加える。'],
                ...
                'EndTurnRetain': [f'本回合结束时，保留最多{var}张[gold]手牌[/gold]。', f'At the end of this turn, retain up to {var} cards from your [gold]hand[/gold].', f'このターン終了時、[gold]手札[/gold]から最大{var}枚保留する。'],
