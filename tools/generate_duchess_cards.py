    ...
    for effect in row[7]:
        ...
        if kind == 'Damage':
            ...
            templates = {
                ...
                'ShuffleAoeDamage': [f'这张牌每次被洗入[gold]抽牌堆[/gold]，对所有敌人造成{var}点伤害。', f'Whenever this card is shuffled into your [gold]draw pile[/gold], deal {var} damage to ALL enemies.', f'このカードが[gold]山札[/gold]に加えてシャッフルされるたび、敵全体に{var}ダメージを与える。'],
