...
updates = {
    ...
    "Quickstep": row(["ElegantBearing", "优雅身段", "Elegant Bearing", "優雅な身ごなし"], 1, "Skill", "Basic",
                     [["DodgeToDraw", 3, 3], ["Draw", 2, 2]], {"upgradeTokens": True}),
    "Stiletto": row(["Stiletto", "细刃", "Stiletto", "細刃"], 1, "Attack", "Common",
                    [["Damage", 6, 9]], {"reaction": True}),
    "PassingCut": row(["PassingCut", "擦身斩", "Passing Cut", "すれ違い斬り"], 1, "Attack", "Common",
                      [["Damage", 7, 10], ["Block", 3, 4]], {"reaction": True}),
    "BlindSpot": row(["BlindSpot", "视线之外", "Blind Spot", "死角"], 1, "Attack", "Common",
                     [["Damage", 9, 12], ["Vulnerable", 1, 2, "moment"]], {"moment": 4}),
    ...
    "MaskedAssault": row(["MaskedAssault", "假面突袭", "Masked Assault", "仮面の急襲"], 1, "Attack", "Uncommon",
                         [["Damage", 11, 15], ["Draw", 1, 2, "moment"]], {"reaction": True, "moment": 5}),
    "CutAndFade": row(["CutAndFade", "斩后隐去", "Cut and Fade", "斬って消える"], 2, "Attack", "Uncommon",
                      [["Damage", 13, 17], ["DodgeToDraw", 1, 2]]),
    "SecondThought": row(["SecondThought", "补上一刀", "Second Thought", "念押し"], 1, "Attack", "Uncommon",
                        [["Damage", 8, 11], ["Draw", 1, 1, "moment"]], {"reaction": True, "moment": 3}),
    ...
    "Encore": row(["Encore", "再来一次", "Encore", "もう一度"], 1, "Skill", "Uncommon",
                  [["ShuffleDiscard", 2, 3], ["Draw", 2, 3]], {"exhaust": True}),
    ...
    "VanishingAct": row(["VanishingAct", "凭空消失", "Vanishing Act", "忽然と消える"], 2, "Skill", "Rare",
                        [["Block", 18, 24], ["DodgeToHand", 2, 3]], {"exhaust": True}),
